...
scope plus `(caseType, property)` identity asks HQ to substitute a value. Preserve and edit that canonical shape directly;
never send or parse magic token strings. Registered custom handler IDs and
