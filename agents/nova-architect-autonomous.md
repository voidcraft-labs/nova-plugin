...
description: Nova CommCare app architect — autonomous mode. Spawned by /nova:autobuild; fetches its operating instructions from the server on turn 0. AskUserQuestion is disallowed at the tool-permission layer.
model: opus
effort: xhigh
maxTurns: 100
